...
namespace Mono_Ether {
    public class TitleScreen : GameState {
        ...
        private void DrawBG(SpriteBatch batch) {
            ...
            /* Tree Leaves */
            batch.Draw(_treeLeaf, new Vector2(GameSettings.ScreenSize.X / 2f - 484f, GameSettings.ScreenSize.Y / 2f - 120f), null, Color.White, 0.1f + MathF.Sin(_framesSinceStart / 60f) / 3f, new Vector2(0, _treeLeaf.Height), 1.2f, 0, 0);
            batch.Draw(_treeLeaf, new Vector2(GameSettings.ScreenSize.X / 2f - 484f, GameSettings.ScreenSize.Y / 2f - 115f), null, Color.White, -0.4f + MathF.Sin(_framesSinceStart / 50f + 1) / 2.9f, new Vector2(0, _treeLeaf.Height), 1.2f, 0, 0);
            batch.Draw(_treeLeaf, new Vector2(GameSettings.ScreenSize.X / 2f - 484f, GameSettings.ScreenSize.Y / 2f - 110f), null, Color.White, 0.3f + MathF.Sin(_framesSinceStart / 70f) / 2.5f, new Vector2(0, _treeLeaf.Height), 1.2f, 0, 0);
            batch.Draw(_treeLeaf, new Vector2(GameSettings.ScreenSize.X / 2f - 484f, GameSettings.ScreenSize.Y / 2f - 120f), null, Color.White, 3.5f + MathF.Sin(_framesSinceStart / 65f + 1) / 3.5f, new Vector2(0, _treeLeaf.Height), 1.2f, 0, 0);
            batch.Draw(_treeLeaf, new Vector2(GameSettings.ScreenSize.X / 2f - 484f, GameSettings.ScreenSize.Y / 2f - 115f), null, Color.White, 2.9f + MathF.Sin(_framesSinceStart / 55f) / 4f, new Vector2(0, _treeLeaf.Height), 1.2f, 0, 0);
            batch.Draw(_treeLeaf, new Vector2(GameSettings.ScreenSize.X / 2f - 680f, GameSettings.ScreenSize.Y / 2f - 20f), null, Color.White, 0.1f + MathF.Sin(_framesSinceStart / 75f + 1) / 2.7f, new Vector2(0, _treeLeaf.Height), 1.2f, 0, 0);
            batch.Draw(_treeLeaf, new Vector2(GameSettings.ScreenSize.X / 2f - 680f, GameSettings.ScreenSize.Y / 2f - 20f), null, Color.White, 3.1f + MathF.Sin(_framesSinceStart / 85f) / 3.3f, new Vector2(0, _treeLeaf.Height), 1.2f, 0, 0);
            batch.Draw(_treeLeaf, new Vector2(GameSettings.ScreenSize.X / 2f + 484f, GameSettings.ScreenSize.Y / 2f - 120f), null, Color.White, 3.1f + MathF.Sin(_framesSinceStart / 50f) / 2.9f, new Vector2(0, _treeLeaf.Height), 1.2f, 0, 0);
            batch.Draw(_treeLeaf, new Vector2(GameSettings.ScreenSize.X / 2f + 484f, GameSettings.ScreenSize.Y / 2f - 115f), null, Color.White, -3.4f + MathF.Sin(_framesSinceStart / 60f + 1) / 3f, new Vector2(0, _treeLeaf.Height), 1.2f, 0, 0);
            batch.Draw(_treeLeaf, new Vector2(GameSettings.ScreenSize.X / 2f + 484f, GameSettings.ScreenSize.Y / 2f - 110f), null, Color.White, 3.3f + MathF.Sin(_framesSinceStart / 65f) / 2.9f, new Vector2(0, _treeLeaf.Height), 1.2f, 0, 0);
            batch.Draw(_treeLeaf, new Vector2(GameSettings.ScreenSize.X / 2f + 484f, GameSettings.ScreenSize.Y / 2f - 120f), null, Color.White, 0.5f + MathF.Sin(_framesSinceStart / 70f + 1) / 4f, new Vector2(0, _treeLeaf.Height), 1.2f, 0, 0);
            batch.Draw(_treeLeaf, new Vector2(GameSettings.ScreenSize.X / 2f + 484f, GameSettings.ScreenSize.Y / 2f - 115f), null, Color.White, 0.9f + MathF.Sin(_framesSinceStart / 85f) / 3.5f, new Vector2(0, _treeLeaf.Height), 1.2f, 0, 0);
            batch.Draw(_treeLeaf, new Vector2(GameSettings.ScreenSize.X / 2f + 680f, GameSettings.ScreenSize.Y / 2f - 20f), null, Color.White, 3.1f + MathF.Sin(_framesSinceStart / 55f + 1) / 3.3f, new Vector2(0, _treeLeaf.Height), 1.2f, 0, 0);
            batch.Draw(_treeLeaf, new Vector2(GameSettings.ScreenSize.X / 2f + 680f, GameSettings.ScreenSize.Y / 2f - 20f), null, Color.White, 0.1f + MathF.Sin(_framesSinceStart / 75f) / 2.7f, new Vector2(0, _treeLeaf.Height), 1.2f, 0, 0);
            /* SubBars */
            for (int i = 0; i < 6; i++)
